...
blocked_by_openai_safety:
  ...
  If manual.gate itself is blocked by OpenAI safety checks, stop immediately, do not try another tool, and wait for human completion followed by /resume.
